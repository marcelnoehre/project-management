...
async function createTask(req, res, next) {
    try {
        ...
        tasksCollection.doc(newDocRef.id).set(task).then(async () => {
            await notificationsService.createNotification(db, req, req.body.project, req.body.author, 'NOTIFICATIONS.NEW.CREATE_TASK', [req.body.author, req.body.title], 'note_add');
